...
type Request struct {
	...
	CoreDumpConfig       *CoreDumpConfigRequest `protobuf:"bytes,17,opt,name=CoreDumpConfig,proto3" json:"CoreDumpConfig,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
type Response struct {
	...
	CoreDumpConfig       *CoreDumpConfigResponse `protobuf:"bytes,17,opt,name=CoreDumpConfig,proto3" json:"CoreDumpConfig,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
var fileDescriptor_5c6ac9b241082464 = []byte{
	...
	,
}
...
func (m *TxnInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n29, err29 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.CreateAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.CreateAt):])
	if err29 != nil {
		return 0, err29
	}
	i -= n29
	i = encodeVarintQuery(dAtA, i, uint64(n29))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
