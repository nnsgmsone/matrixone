...
func (Pipeline_PipelineType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7ac67a7adf3df9c7, []int{30, 0}
}
...
func (m *Connector) GetTypes() []*plan.Type {
	if m != nil {
		return m.Types
	}
	return nil
...
type Dispatch struct {
	...
	Types                []*plan.Type `protobuf:"bytes,4,rep,name=types,proto3" json:"types,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *Dispatch) GetTypes() []*plan.Type {
	if m != nil {
		return m.Types
	}
	return nil
...
type Insert struct {
	...
	OnDuplicateExpr      map[string]*plan.Expr `protobuf:"bytes,4,rep,name=on_duplicate_expr,json=onDuplicateExpr,proto3" json:"on_duplicate_expr,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Ref                  *plan.ObjectRef       `protobuf:"bytes,5,opt,name=ref,proto3" json:"ref,omitempty"`
	TableDef             *plan.TableDef        `protobuf:"bytes,6,opt,name=table_def,json=tableDef,proto3" json:"table_def,omitempty"`
	...
	IdxIdx               []int32               `protobuf:"varint,9,rep,packed,name=idx_idx,json=idxIdx,proto3" json:"idx_idx,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *Insert) GetOnDuplicateIdx() []int32 {
	if m != nil {
...
func (m *Insert) GetOnDuplicateExpr() map[string]*plan.Expr {
	if m != nil {
...
type Join struct {
	...
	RightTypes           []*plan.Type `protobuf:"bytes,9,rep,name=right_types,json=rightTypes,proto3" json:"right_types,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *Join) GetRightTypes() []*plan.Type {
	if m != nil {
		return m.RightTypes
	}
	return nil
...
type AntiJoin struct {
	...
	RightTypes           []*plan.Type `protobuf:"bytes,8,rep,name=right_types,json=rightTypes,proto3" json:"right_types,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *AntiJoin) GetRightTypes() []*plan.Type {
	if m != nil {
		return m.RightTypes
	}
	return nil
...
func (m *InnerJoin) GetRightTypes() []*plan.Type {
	if m != nil {
		return m.RightTypes
	}
	return nil
...
func (m *LeftJoin) GetRightTypes() []*plan.Type {
	if m != nil {
		return m.RightTypes
	}
	return nil
...
func (m *SemiJoin) GetRightTypes() []*plan.Type {
	if m != nil {
		return m.RightTypes
	}
	return nil
...
func (m *SingleJoin) GetRightTypes() []*plan.Type {
	if m != nil {
		return m.RightTypes
	}
	return nil
...
func (m *MarkJoin) GetRightTypes() []*plan.Type {
	if m != nil {
		return m.RightTypes
	}
	return nil
...
type Product struct {
	...
	Types                []*plan.Type `protobuf:"bytes,3,rep,name=types,proto3" json:"types,omitempty"`
	RightTypes           []*plan.Type `protobuf:"bytes,4,rep,name=right_types,json=rightTypes,proto3" json:"right_types,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *Product) GetRightTypes() []*plan.Type {
	if m != nil {
		return m.RightTypes
	}
	return nil
...
func (m *TableFunction) GetTypes() []*plan.Type {
	if m != nil {
		return m.Types
	}
	return nil
...
type ExternalScan struct {
	...
	OriginCols           []*plan.ColDef           `protobuf:"bytes,6,rep,name=origin_cols,json=originCols,proto3" json:"origin_cols,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
type UnionAll struct {
	ChildrenNumber       uint64   `protobuf:"varint,1,opt,name=children_number,json=childrenNumber,proto3" json:"children_number,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *UnionAll) GetChildrenNumber() uint64 {
	if m != nil {
		return m.ChildrenNumber
	}
	return 0
}
...
type Instruction struct {
	...
	Filter         *plan.Expr          `protobuf:"bytes,22,opt,name=filter,proto3" json:"filter,omitempty"`
	Limit          uint64              `protobuf:"varint,23,opt,name=limit,proto3" json:"limit,omitempty"`
	Offset         uint64              `protobuf:"varint,24,opt,name=offset,proto3" json:"offset,omitempty"`
	// isFirst identifies whether it is the first instruction of analyzeInfo corresponding to idx
	IsFirst bool `protobuf:"varint,25,opt,name=isFirst,proto3" json:"isFirst,omitempty"`
	// isLast identifies whether it is the last instruction of analyzeInfo corresponding to idx
	IsLast               bool         `protobuf:"varint,26,opt,name=isLast,proto3" json:"isLast,omitempty"`
	RightJoin            *RightJoin   `protobuf:"bytes,27,opt,name=right_join,json=rightJoin,proto3" json:"right_join,omitempty"`
	UnionAll             *UnionAll    `protobuf:"bytes,28,opt,name=union_all,json=unionAll,proto3" json:"union_all,omitempty"`
	Types                []*plan.Type `protobuf:"bytes,29,rep,name=types,proto3" json:"types,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *Instruction) GetTypes() []*plan.Type {
	if m != nil {
		return m.Types
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*plan.Expr)(nil), "pipeline.Insert.OnDuplicateExprEntry")
...
var fileDescriptor_7ac67a7adf3df9c7 = []byte{
	...
	,
}
...
func (m *Insert) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OnDuplicateIdx) > 0 {
		dAtA9 := make([]byte, len(m.OnDuplicateIdx)*10)
		var j8 int
...
func (m *OnDuplicateKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OnDuplicateIdx) > 0 {
		dAtA15 := make([]byte, len(m.OnDuplicateIdx)*10)
		var j14 int
		for _, num1 := range m.OnDuplicateIdx {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *Join) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColList) > 0 {
		dAtA18 := make([]byte, len(m.ColList)*10)
		var j17 int
	...
	if len(m.RelList) > 0 {
		dAtA20 := make([]byte, len(m.RelList)*10)
		var j19 int
...
func (m *AntiJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		dAtA23 := make([]byte, len(m.Result)*10)
		var j22 int
...
func (m *InnerJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColList) > 0 {
		dAtA26 := make([]byte, len(m.ColList)*10)
		var j25 int
		for _, num1 := range m.ColList {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.RelList) > 0 {
		dAtA28 := make([]byte, len(m.RelList)*10)
		var j27 int
		for _, num1 := range m.RelList {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *SemiJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		dAtA41 := make([]byte, len(m.Result)*10)
		var j40 int
		for _, num1 := range m.Result {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *SingleJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColList) > 0 {
		dAtA44 := make([]byte, len(m.ColList)*10)
		var j43 int
		for _, num1 := range m.ColList {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.RelList) > 0 {
		dAtA46 := make([]byte, len(m.RelList)*10)
		var j45 int
		for _, num1 := range m.RelList {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *UnionAll) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ChildrenNumber != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.ChildrenNumber))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ProcessInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AnalysisNodeList) > 0 {
		dAtA78 := make([]byte, len(m.AnalysisNodeList)*10)
		var j77 int
...
func (m *UnionAll) ProtoSize() (n int) {
	...
	_ = l
	if m.ChildrenNumber != 0 {
		n += 1 + sovPipeline(uint64(m.ChildrenNumber))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *UnionAll) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChildrenNumber", wireType)
			}
			m.ChildrenNumber = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ChildrenNumber |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
