...
func TestPartition(t *testing.T) {
	...
	v0 := vector.New(0, types.T_int8.ToType())
	...
	v1 := vector.New(0, types.T_int16.ToType())
	...
	v2 := vector.New(0, types.T_int32.ToType())
	...
	v3 := vector.New(0, types.T_int64.ToType())
	...
	v4 := vector.New(0, types.T_uint8.ToType())
	...
	v5 := vector.New(0, types.T_uint16.ToType())
	...
	v6 := vector.New(0, types.T_uint32.ToType())
	...
	v7 := vector.New(0, types.T_uint64.ToType())
	...
	v8 := vector.New(0, types.T_date.ToType())
	...
	v9 := vector.New(0, types.T_float32.ToType())
	...
	v10 := vector.New(0, types.T_float64.ToType())
	...
	v11 := vector.New(0, types.T_char.ToType())
